...
- **Claude Code:** review of the built application against the plan and the designs, the backend restructure, refactoring, the demo simulation, and a final pass that removed structure which had stopped paying for itself. Used across four sessions, working against the running app and driven largely by screenshots and code review rather than fresh specification.
